...
class _$AbsenceImpl implements _Absence {
  ...
  @override
  String toString() {
    return 'Absence(admitterId: $admitterId, admitterNote: $admitterNote, confirmedAt: $confirmedAt, createdAt: $createdAt, crewId: $crewId, endDate: $endDate, id: $id, memberNote: $memberNote, rejectedAt: $rejectedAt, startDate: $startDate, type: $type, userId: $userId)';
  }
